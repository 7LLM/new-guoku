<template>
	<section class="produList">
		...
		<Model_itema mark="one" :selected="selected" @change="getVal">
			<span slot="subtitle" class="subtitle" id="subbtitle">彩虹果杯</span>
			<div slot="content" class="pro_list">
				<div class="listLeft">
					<img src="../../assets/mallImg/recommend_img2.jpg" />
					<div class="mask"><a href="#">立即查看</a></div>
				</div>
				<div class="listRight">
					<div class="listRight_item" v-for="(item,index) in pro" :key="index" v-show="index>=30&&index<=35">
						<a href="#">
		...
		<Model_itema mark="two" :selected="selected" @change="getVal">
			<span slot="subtitle" class="subtitle">大型果杯</span>
			<div slot="content" class="pro_list">
				<div class="listLeft">
					<img src="../../assets/mallImg/recommend_img2.jpg" />
					<div class="mask"><a href="#">立即查看</a></div>
		...
		<Model_itema mark="three" :selected="selected" @change="getVal">
			<span slot="subtitle" class="subtitle">中型果杯</span>
			<div slot="content" class="pro_list">
				<div class="listLeft">
					<img src="../../assets/mallImg/recommend_img2.jpg" />
					<div class="mask"><a href="#">立即查看</a></div>
		...
		<Model_itema mark="four" :selected="selected" @change="getVal">
			<span slot="subtitle" class="subtitle">标准果杯</span>
			<div slot="content" class="pro_list">
				<div class="listLeft">
					<img src="../../assets/mallImg/recommend_img2.jpg" />
					<div class="mask"><a href="#">立即查看</a></div>
		...
		<Model_itema mark="five" :selected="selected" @change="getVal">
			<span slot="subtitle" class="subtitle">迷你果杯</span>
			<div slot="content" class="pro_list">
				<div class="listLeft">
					<img src="../../assets/mallImg/recommend_img2.jpg" />
					<div class="mask"><a href="#">立即查看</a></div>
