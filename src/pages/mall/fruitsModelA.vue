<template>
	<section class="produList">
		...
		<Model_itema mark="one" :selected="selected" @change="getVal">
			<span slot="subtitle" class="subtitle" id="subbtitle">专利分格</span>
			<div slot="content" class="pro_list">
				<div class="listLeft">
					<img src="../../assets/mallImg/recommend_img1.jpg" />
		...
		<Model_itema mark="two" :selected="selected" @change="getVal">
			<span slot="subtitle" class="subtitle">超级果盒</span>
			<div slot="content" class="pro_list">
				<div class="listLeft">
					<img src="../../assets/mallImg/recommend_img1.jpg" />
					<div class="mask"><a href="#">立即查看</a></div>
		...
		<Model_itema mark="three" :selected="selected" @change="getVal">
			<span slot="subtitle" class="subtitle">三分果盒</span>
			<div slot="content" class="pro_list">
				<div class="listLeft">
					<img src="../../assets/mallImg/recommend_img1.jpg" />
					<div class="mask"><a href="#">立即查看</a></div>
		...
		<Model_itema mark="four" :selected="selected" @change="getVal">
			<span slot="subtitle" class="subtitle">两分果盒</span>
			<div slot="content" class="pro_list">
				<div class="listLeft">
					<img src="../../assets/mallImg/recommend_img1.jpg" />
					<div class="mask"><a href="#">立即查看</a></div>
		...
		<Model_itema mark="five" :selected="selected" @change="getVal">
			<span slot="subtitle" class="subtitle">迷你果盒</span>
			<div slot="content" class="pro_list">
				<div class="listLeft">
					<img src="../../assets/mallImg/recommend_img1.jpg" />
					<div class="mask"><a href="#">立即查看</a></div>
